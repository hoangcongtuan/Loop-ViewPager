...
package com.example.customviewpager2.infinitylayoutmanager
...
class LoopingLayoutManager : LayoutManager, RecyclerView.SmoothScroller.ScrollVectorProvider {
     ...
     */
    private lateinit var mAccessibilityProvider: ViewPager2.AccessibilityProvider
    @JvmOverloads
    public constructor(mAccessibilityProvider: ViewPager2.AccessibilityProvider, context: Context, orientation: Int = VERTICAL, reverseLayout: Boolean = false) {
     ...
     */
    public constructor(mAccessibilityProvider: ViewPager2.AccessibilityProvider, context: Context, attrs: AttributeSet, defStyleAttr: Int, defStyleRes: Int) {
        this.mAccessibilityProvider = mAccessibilityProvider
    ...
    * @return The actually distance scrolled. This will equal to delta unless the layout manager
    ...
    override fun performAccessibilityAction(
        ...
        return if (mAccessibilityProvider.handlesLmPerformAccessibilityAction(action)) {
            mAccessibilityProvider.onLmPerformAccessibilityAction(action)
        } else super.performAccessibilityAction(recycler, state, action, args)
    }
