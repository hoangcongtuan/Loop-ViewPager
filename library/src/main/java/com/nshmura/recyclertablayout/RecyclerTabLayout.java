...
public class RecyclerTabLayout extends RecyclerView {
    ...
    protected ViewPagerCustom1 mViewPager;
    ...
    public void setUpWithViewPager(ViewPagerCustom1 viewPager) {
    ...
    protected static class ViewPagerOnPageChangeListener implements ViewPagerCustom1.OnPageChangeListener {
    ...
    public static abstract class Adapter<T extends RecyclerView.ViewHolder>
        ...
        public Adapter(ViewPagerCustom1 viewPager) {
            mViewPager = viewPager;
        }

        public ViewPagerCustom1 getViewPager() {
            return mViewPager;
        }
    ...
    public static class DefaultAdapter
        ...
        public DefaultAdapter(ViewPagerCustom1 viewPager) {
            super(viewPager);
        }
